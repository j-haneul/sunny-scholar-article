...
const SUNNY_DATA = [
    ...
    <blockquote>
      <p>“가정위탁 배경 자립준비청년의 아킬레스건이 나를 돌봐줬던 분이잖아요. 부모 대신 그들에게 은혜를 갚아야 한다는 생각이 굉장히 강합니다. 그래서 분리를 하지 못합니다.”<br/>(자립지원전담기관 담당자)</p>
    </blockquote>
    <p>비슷한 경험은 다른 자립준비청년에게도 이어집니다.</p>
        <blockquote>
    <p>“지난 학기에는 일하느라 학점이 부족해서 장학금에서 탈락했습니다. 그래서 제 통장을 깨고, 돈을 더 빌려서 280만 원을 만들어 등록금으로 마련했습니다.”<br/>(연구참여자 지민)<sup>1</sup></p>    </blockquote>
  ...
  `,
    ...
    },
    {
        ...
        content: `
            <p>1편에서 만났던 성진이를 기억하시나요? 스물한 살 성진이는 어린 시절부터 줄곧 할머니의 보살핌 속에서 자라왔습니다...</p>
            <div class="img-container">
                <img src="images/fore_3.jpg" class="content-img" alt="가족 돌봄 이미지">
                <p class="img-caption">▲ 이미지 출처 : ChatGPT 생성 이미지</p>
            </div>
            <p>문제는 이들이 성인이 된 후입니다. 이들 10명 중 4명은 제도상 자립이 시작되었음에도 집을 떠나지 못합니다...</p>
            <div class="footnote-section">
